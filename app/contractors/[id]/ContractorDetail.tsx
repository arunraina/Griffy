...
import { Star, MapPin, CheckCircle2, Phone, Calendar, Shield, Clock, Award, ChevronRight, MessageSquare, Share2 } from "lucide-react";
...
export default function ContractorDetailPage() {
  ...
  const shareText = `${contractor.businessName} — ${SPECIALTY_LABEL[contractor.specialty] ?? contractor.specialty} on Griffy${contractor.city ? " in " + contractor.city : ""}`;
  ...
  const jsonLd = {
    ...
    image: contractor.avatarUrl ?? undefined,
    address: contractor.city ? {
      "@type": "PostalAddress",
      addressLocality: contractor.city,
      addressRegion: contractor.state ?? undefined,
      addressCountry: "IN",
    } : undefined,
    ...
    priceRange: contractor.priceRangeMin ? `₹${Number(contractor.priceRangeMin).toLocaleString("en-IN")}+` : undefined,
  };
